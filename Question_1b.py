...
stress_local_lst_large = Stress_ply_calculation_1b(strain_local_lst_large, Q0) #Q0 is the unrotated stiffness matrix for each ply, which is the same for all plies in this case since they are all made of the same material.



# Plot strain vs thickness for each component  #Copilot assisted in writing the plotting functions, but no other code was generated by Copilot. 
